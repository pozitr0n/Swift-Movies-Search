...
class MainViewController: UIViewController {
    ...
    @IBAction func showInfoAboutApplication(_ sender: Any) {
        ...
        SwiftEntryKit.display(entry: SmallPopupUIView(image: #imageLiteral(resourceName: "icon_tmdb"), name: "You have successfully logged in with your personal session key"), using: setupAttributes())
